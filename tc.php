<?php
define("TITLE", "Terms & Conditions | ConvertedCode");
...
<section class="doctor spad">
    <div class="container">
        ...
        <p>These terms and conditions apply to You, the user of this website (including any sub-domains, unless
            expressly excluded by their own terms and conditions), Convertedcode Limited, with the the following URL web
            address: <a href="www.convertedcode.com">www.convertedcode.com</a>.</p>
        <br>
